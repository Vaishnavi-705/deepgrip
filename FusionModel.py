...
main = tkinter.Tk()
main.title("An ensemble model for image forgery detection using transfer learning")
...
font = ('times', 14, 'bold')
title = Label(main, text='An ensemble model for image forgery detection using transfer learning')
